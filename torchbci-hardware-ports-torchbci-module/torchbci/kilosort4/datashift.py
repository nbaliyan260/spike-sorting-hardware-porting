...
from torchbci.kilosort4 import spikedetect
...
def run(ops, bfile, device=torch.device('cuda'), progress_bar=None,
    ...
    st, _, ops  = spikedetect.run(
        ...
        clear_cache=clear_cache, verbose=verbose, optimize_memory=optimize_memory, deterministic_mode=deterministic_mode, seed=seed
        )
